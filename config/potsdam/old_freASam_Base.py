...
UNFREEZE_SCHEDULE = [
    ...
    {"epoch": 2, "blocks": {"type": "last", "n": 6}, "parts": ["mlp"]},
...
train_dataset = PotsdamDataset(
    data_root=r'H:\Datasets\Potsdam_New\Images\train_dataset\augmented',
    mosaic_ratio=0.0,
    transform=train_aug
)
val_dataset = PotsdamDataset(
    data_root=r'H:\Datasets\Potsdam_New\Images\test_dataset',
    mosaic_ratio=0.0,
    transform=val_aug
)
