...
from geoseg.models.FreASam.FreASam_BasePlus import FreASam
import os
...
UNFREEZE_SCHEDULE = [
    ...
    {"epoch": 1, "blocks": {"type": "last", "n": 4}, "parts": ["mlp"]},
...
# 分组学习率
lr = 1.5e-3             # 头部
backbone_lr = 1.5e-4      # encoder 主干
lr_enc_mlp = 2.0e-4     # encoder 的 MLP/LoRA
