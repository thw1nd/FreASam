...
UNFREEZE_SCHEDULE = [
    ...
    {"epoch": 10, "blocks": {"type": "all"}, "parts": ["norm"]},

    {"epoch": 15, "blocks": {"type": "last", "n": 2}, "parts": ["mlp"]},

    {"epoch": 20, "blocks": {"type": "last", "n": 6}, "parts": ["mlp"]},
    # {"epoch": 30, "blocks": {"type": "last", "n": 4}, "parts": ["attn"]},
